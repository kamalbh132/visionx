...
const FULL_WIDTH_PATHS = ["/projects", "/messages", "/user/notifications", "/admin/notifications", "/superadmin/notifications", "/user/settings", "/admin/settings", "/superadmin/settings"];
